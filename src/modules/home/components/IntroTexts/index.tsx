...
export default function IntroTexts({ className, ...rest }: React.HTMLAttributes<HTMLDivElement>) {
  ...
  const description = (
    <Typography>
      I pride myself on being a results-driven full-stack developer based in Dhaka, Bangladesh. I
      have over {diff} years of experience in creating cross-platform software applications for
      various companies.
      {/* <br />
